...
# ==============================================================================
# CARREGAMENTO INTELIGENTE DE TEMAS E PLUGINS (Fedora + Arch Linux)
# ==============================================================================

# 1. Powerlevel10k
if [[ -f /usr/share/zsh/themes/powerlevel10k/powerlevel10k.zsh-theme ]]; then
  source /usr/share/zsh/themes/powerlevel10k/powerlevel10k.zsh-theme # Fedora
...
if [[ -f /usr/share/zsh-autosuggestions/zsh-autosuggestions.zsh ]]; then
  source /usr/share/zsh-autosuggestions/zsh-autosuggestions.zsh # Fedora
